...
class SocialAccount{
	...
	public SocialAccount setAge(int age){
		this.age = age;
		return this;
	}

	public SocialAccount setFirstName(String firstName) {
		this.firstName = firstName;
		return this;
	}

	public SocialAccount setLastName(String lastName) {
		this.lastName = lastName;
		return this;
	}

	public SocialAccount setLocation(String location) {
		this.location = location;
		return this;
	}

	public SocialAccount setPhoneNumber(String phoneNumber) {
		this.phoneNumber = phoneNumber;
		return this;
	}

	public SocialAccount setEmail(String email) {
		this.email = email;
		return this;
	}

	public SocialAccount setProfileURl(String profileURl) {
		this.profileURl = profileURl;
		return this;
	}

	public SocialAccount setBio(String bio) {
		this.bio = bio;
		return this;
	}
}
